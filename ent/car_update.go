...
func (cu *CarUpdate) SetCarID(u uuid.UUID) *CarUpdate {
	cu.mutation.SetCarID(u)
	return cu
}
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.CarID(); ok {
...
// SetCarID sets the "car_id" field.
func (cuo *CarUpdateOne) SetCarID(u uuid.UUID) *CarUpdateOne {
	cuo.mutation.SetCarID(u)
	return cuo
}
...
func (cuo *CarUpdateOne) sqlSave(ctx context.Context) (_node *Car, err error) {
	...
	if value, ok := cuo.mutation.CarID(); ok {
		_spec.SetField(car.FieldCarID, field.TypeUUID, value)
	}
